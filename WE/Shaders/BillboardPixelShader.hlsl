...
float4 MainPS(FGSOutput pin) : SV_Target
{
    ...
    float4 diffuseAlbedo = gTexture[MaterialData.TextureIndex].Sample(gsamAnisotropicWrap, pin.TexC) * MaterialData.DiffuseAlbedo;

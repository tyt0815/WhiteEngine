...
using WActionCreator = std::function<WActionLambda(WObject*, const WAttributesMap&)>;
...
public:
    ...
    __forceinline static WActionLambda Create(const std::string& Tag, WObject* Target, const WAttributesMap& Attributes)
    {
        return GetInstance()->Create_Internal(Tag, Target, Attributes);
    }
...
private:
    ...
    WActionLambda Create_Internal(const std::string& Tag, WObject* Target, const WAttributesMap& Attributes);

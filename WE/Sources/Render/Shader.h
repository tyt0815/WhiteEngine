...
private:
	...
	Microsoft::WRL::ComPtr<ID3D12PipelineState> mCubeSkyPipelineState;
...
public:
	...
	inline ID3D12PipelineState* GetCubeSkyPipelineStatePtr() const
	{
		return mCubeSkyPipelineState.Get();
	}
